    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 inline-flex h-96 w-[794px] flex-col items-start justify-start gap-5 rounded-[20px] bg-white px-10 py-7 shadow-[0px_2px_10px_0px_rgba(0,0,0,0.10)]">
        <div className="flex w-32 flex-col items-start justify-start gap-2.5">
          <div className="self-stretch font-['Pretendard_Variable'] text-xl leading-7 font-medium text-black">
            내 정보 수정
          </div>
          <div className="self-stretch font-['Pretendard_Variable'] text-sm leading-tight font-normal text-neutral-600">
            내 정보를 수정합니다.
          </div>
        </div>
        ...
        <div className="flex flex-col items-start justify-start gap-5 self-stretch overflow-y-auto">
          <div className="flex flex-col items-start justify-start gap-2 self-stretch">
            <div className="font-['Pretendard_Variable'] text-base leading-normal font-medium text-black">
              닉네임 수정
            </div>
            <div className="inline-flex items-center self-stretch rounded-[10px] bg-neutral-100 px-3 py-3.5">
              <input
                className="h-[1em] w-full font-['Pretendard_Variable'] text-xs font-normal text-neutral-600 placeholder:text-zinc-500 focus:outline-none"
            ...
            {error && (
              <div className="font-['Pretendard_Variable'] text-xs leading-none font-normal text-red-500">
                올바르지 않은 닉네임입니다.
              </div>
            )}
          </div>
          ...
          <div className="flex flex-col items-start justify-center gap-2 self-stretch">
            ...
            <div className="w-full">
              {isGradeOpen ? (
                <div className="mt-1 flex w-full flex-col overflow-hidden rounded-[10px] bg-neutral-100">
                  {['1학년', '2학년', '3학년', '4학년'].map((item) => (
                    <div
                      key={item}
                ...
                <div
                  className="inline-flex w-full cursor-pointer items-center justify-between rounded-[10px] bg-neutral-100 px-3 py-3.5"
                  onClick={() => setIsGradeOpen(!isGradeOpen)}
                >
                  <div className="font-['Pretendard_Variable'] text-xs leading-none font-normal text-zinc-500">
        ...
        >
          <div className="inline-flex cursor-pointer items-center justify-center gap-2.5 self-stretch rounded-lg bg-red-400 px-5 py-3">
            <div className="font-['Pretendard_Variable'] text-base leading-normal font-medium text-white">
              내 정보 수정
            </div>
          </div>
        </div>
