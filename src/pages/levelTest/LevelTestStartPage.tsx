...
const LevelTestStartPage = () => {
  ...
  const hideSidebar = pathname === '/level-test/start';
  ...
  return (
    <div className="flex h-dvh w-full bg-primary-bg p-5">
      <div
        className={`flex h-full w-full ${hideSidebar ? 'items-center justify-center' : 'gap-6'}`}
      >
        {!hideSidebar && (
                ...
                onClick={() => {
                  ...
                  navigate('/question/test', {
                    state: {
                      ...
                      subjectUnitIds: subjectUnitIdsToSend,
                    },
                  });
                }}
              >
